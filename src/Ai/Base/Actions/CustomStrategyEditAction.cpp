...
{
    botAI->TellMaster(botAI->BotTextForMaster("tell_custom_strategies_header", "=== Custom strategies ==="));
    ...
    botAI->TellMaster(botAI->BotTextForMaster("tell_cs_usage", "Usage: cs <name> <idx> <command>"));
    return false;
}
