...
void PlayerbotMgr::CancelLogout()
{
    ...
    for (PlayerBotMap::const_iterator it = GetPlayerBotsBegin(); it != GetPlayerBotsEnd(); ++it)
    {
        ...
        if (bot->GetSession()->isLogingOut())
        {
            ...
            botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_logout_cancelled", "Logout cancelled!"));
        }
    }
...
void PlayerbotHolder::LogoutPlayerBot(ObjectGuid guid)
{
    if (Player* bot = GetPlayerBot(guid))
    {
        ...
        if (!logout)
        {
            ...
            {
                botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_logging_out", "I'm logging out!"));
        ...
        {
            botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_goodbye", "Goodbye!"));
            RemoveFromPlayerbotsMap(guid);                  // deletes bot player ptr inside this WorldSession PlayerBotMap
...
void PlayerbotHolder::OnBotLogin(Player* const bot)
{
    ...
    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_hello_talk", "Hello!"), PLAYERBOT_SECURITY_TALK);
