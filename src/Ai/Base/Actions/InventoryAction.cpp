        ...
        if (proto->Class != oldClass)
        {
            ...
            switch (proto->Class)
            {
                case ITEM_CLASS_CONSUMABLE:
                    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_inv_consumable", "--- consumable ---"));
                    break;
                case ITEM_CLASS_CONTAINER:
                    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_inv_container", "--- container ---"));
                    break;
                case ITEM_CLASS_WEAPON:
                    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_inv_weapon", "--- weapon ---"));
                    break;
                case ITEM_CLASS_ARMOR:
                    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_inv_armor", "--- armor ---"));
                    break;
                case ITEM_CLASS_REAGENT:
                    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_inv_reagent", "--- reagent ---"));
                    break;
                case ITEM_CLASS_PROJECTILE:
                    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_inv_projectile", "--- projectile ---"));
                    break;
                case ITEM_CLASS_TRADE_GOODS:
                    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_inv_trade_goods", "--- trade goods ---"));
                    break;
                case ITEM_CLASS_RECIPE:
                    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_inv_recipe", "--- recipe ---"));
                    break;
                case ITEM_CLASS_QUIVER:
                    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_inv_quiver", "--- quiver ---"));
                    break;
                case ITEM_CLASS_QUEST:
                    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_inv_quest_items", "--- quest items ---"));
                    break;
                case ITEM_CLASS_KEY:
                    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_inv_keys", "--- keys ---"));
                    break;
                case ITEM_CLASS_MISC:
                    botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("msg_inv_other", "--- other ---"));
                    break;
            }
        }
...
void InventoryAction::TellItem(ItemTemplate const* proto, uint32 count, bool soulbound)
{
    ...
    if (soulbound)
        out << botAI->GetLocalizedBotTextOrDefault("msg_soulbound", " (soulbound)");
