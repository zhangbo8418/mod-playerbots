...
void PlayerbotMgr::CancelLogout()
{
    ...
    for (PlayerBotMap::const_iterator it = GetPlayerBotsBegin(); it != GetPlayerBotsEnd(); ++it)
    {
        ...
        if (bot->GetSession()->isLogingOut())
        {
            ...
            botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("logout_cancel", "Logout cancelled!"));
        }
    }
...
*/
        ...
        {
            botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("goodbye", "Goodbye!"));
...
botAI->TellMaster(botAI->GetLocalizedBotTextOrDefault("hello", "Hello!"), PLAYERBOT_SECURITY_TALK);
