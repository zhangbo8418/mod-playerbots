...
bool MovementAction::Follow(Unit* target, float distance, float angle)
{
    ...
    bot->GetMap()->IsBattlegroundOrArena())) return false;
        ...
        bot->CombatStop(true);
        botAI->TellMasterNoFacing(botAI->BotTextForMaster("tell_will_there_soon", "I will there soon."));
        bot->RemoveAurasWithInterruptFlags(AURA_INTERRUPT_FLAG_TELEPORTED | AURA_INTERRUPT_FLAG_CHANGE_MAP);
...
bool DisperseSetAction::Execute(Event event)
{
    ...
    if (text == "disable")
    {
        ...
        botAI->TellMasterNoFacing(botAI->BotTextForMaster("tell_disable_disperse", "Disable disperse"));
        return true;
    }
